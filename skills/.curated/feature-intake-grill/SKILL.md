...
5. Batch routine defaults into 3-5 confirmations when repo conventions or best practice are clear.
6. Record every answer and safe default in `decisions.md`.
